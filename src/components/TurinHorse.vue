<template>
	...
	<g class="guy">
		...
		<path class="wagonPole" d="M 480 347 L 115 310 L 114 322 L 476 358 Z" fill="rgb(35,35,35)">
			<animate attributeName="d" values="M 480 347 L 115 310 L 114 322 L 476 358 Z; M 480 347 L 115 315 L 114 327 L 476 358 Z; M 480 347 L 115 310 L 114 322 L 476 358 Z" dur="0.7s" begin="-0.35s" repeatCount="indefinite" />
		</path>

		<path class="wagonPole" d="M 160 325 L 198 296" stroke="rgb(51,51,51)" stroke-width="4">
			<animate attributeName="d" values="M 160 325 L 198 300;M 160 322 L 198 290;M 160 325 L 198 300;" dur="0.7s" repeatCount="indefinite" />
		</path>
	...
	<path class="ropeHandHorseTop" d="M 444 255 Q 310 280 148 290" stroke="rgb(35,35,35)" stroke-width="3" fill="none">
		<animate attributeName="d" values="M 444 255 Q 310 280 148 290; M 444 255 Q 310 280 149 300; M 444 255 Q 310 280 148 290" dur="0.7s" begin="-0.35s" repeatCount="indefinite" />
	</path>
	...
	<path class="horseLegFrontRight" d="M 208 320 L 216 339 L 201 360 Q 198 364 199 369 L 208 406 L 216 424 L 229 415 L 224 406 L 218 369 L 245 338" fill="rgb(47,47,47)">
		<animate attributeName="d" values="M 208 320 L 216 339 L 201 360 Q 198 364 199 369 L 208 406 L 216 424 L 229 415 L 224 406 L 218 369 L 245 338;M 208 320 L 216 339 L 218 366 Q 216 370 215 377 L 206 410 L 197 430 L 216 430 L 220 416 L 233 375 L 245 338;M 208 320 L 216 339 L 236 375 Q 236 382 238 390 L 242 418 L 236 430 L 253 430 L 257 416 L 253 380 L 245 338;M 208 320 L 216 339 L 209 368 Q 207 374 214 381 L 233 410 L 242 425 L 254 413 L 246 405 L 227 372 L 245 338;M 208 320 L 213 339 L 206 368 Q 204 374 211 381 L 230 410 L 239 425 L 251 413 L 243 405 L 224 372 L 242 338;M 208 320 L 216 339 L 201 360 Q 198 364 199 369 L 208 406 L 216 424 L 229 415 L 224 406 L 218 369 L 245 338" dur="1.4s" begin="-0.7s" repeatCount="indefinite" />
	</path>
	...
	<path class="horseLegBackRight" d="M 320 338 Q 324 362 351 378 L 342 417 L 336 430 L 353 430 L 357 418 L 368 380 L 366 330" fill="rgb(47,47,47)">
		<animate attributeName="d" values="M 320 338 Q 324 362 351 378 L 342 417 L 336 430 L 353 430 L 357 418 L 368 380 L 366 330;M 320 338 Q 324 362 351 378 L 362 417 L 356 430 L 373 430 L 377 418 L 368 380 L 366 330;M 318 338 Q 320 362 355 378 L 345 405 L 349 423 L 362 414 L 359 405 L 373 376 L 366 330;M 318 338 Q 323 362 348 378 L 336 417 L 330 430 L 348 430 L 352 418 L 365 380 L 366 330;M 314 338 Q 320 362 342 378 L 325 417 L 318 430 L 335 430 L 342 418 L 360 380 L 366 330;M 320 338 Q 324 362 351 378 L 342 417 L 336 430 L 353 430 L 357 418 L 368 380 L 366 330" dur="1.4s" repeatCount="indefinite" />
	</path>
	...
	<path class="horseLegBackLeft" d="M 326 338 Q 330 362 357 378 L 348 417 L 342 430 L 359 430 L 363 418 L 374 380 L 366 330" fill="rgb(67,67,67)">
		<animate attributeName="d" values="M 326 338 Q 330 362 357 378 L 348 417 L 342 430 L 359 430 L 363 418 L 374 380 L 366 330;M 326 338 Q 330 362 357 378 L 368 417 L 362 430 L 379 430 L 383 418 L 374 380 L 366 330;M 324 338 Q 326 362 361 378 L 351 405 L 355 423 L 368 414 L 365 405 L 379 376 L 366 330;M 324 338 Q 329 362 354 378 L 342 417 L 336 430 L 354 430 L 358 418 L 371 380 L 366 330;M 320 338 Q 326 362 348 378 L 331 417 L 324 430 L 341 430 L 348 418 L 366 380 L 366 330;M 326 338 Q 330 362 357 378 L 348 417 L 342 430 L 359 430 L 363 418 L 374 380 L 366 330" dur="1.4s" begin="-0.7s" repeatCount="indefinite" />
	</path>
	<path class="horseBody" d="M 371 312 Q 375 270 293 269 Q 193 271 198 308 Q 203 347 283 349 Q 323 342 344 343 Q 370 346 371 312" fill="rgb(67,67,67)">
		<animate attributeName="d" values="M 371 312 Q 375 270 293 269 Q 193 271 198 308 Q 203 347 283 349 Q 323 342 344 343 Q 370 346 371 312; M 371 307 Q 375 265 293 269 Q 193 266 198 303 Q 203 342 283 343 Q 323 337 344 338 Q 370 341 371 307; M 371 312 Q 375 270 293 269 Q 193 271 198 308 Q 203 347 283 349 Q 323 342 344 343 Q 370 346 371 312" dur="0.7s" begin="-0.35" repeatCount="indefinite" calcMode="spline" keyTimes="0; 0.5; 1" keySplines="0 0.33 0.66 1; 0.1 0.7 0.9 0.1" />
	</path>
	...
	<path class="horseHead" d="M 300 269 Q 239 261 166 233 Q 152 229 149 240 Q 144 250 141 266 L 134 298 L 153 311 L 181 279 L 202 320 Z" fill="rgb(67,67,67)">
		<animate attributeName="d" values="M 300 269 Q 239 261 166 233 Q 152 229 149 240 Q 144 250 141 266 L 131 303 L 153 311 L 181 279 L 202 320 L 205 325 Z; M 300 269 Q 239 261 160 238 Q 146 234 143 252 Q 141 260 140 270 L 134 310 L 159 317 L 175 288 L 202 320 L 205 325 Z; M 300 269 Q 239 261 166 233 Q 152 229 149 240 Q 144 250 141 266 L 131 303 L 153 311 L 181 279 L 202 320 L 205 325 Z" dur="0.7s" begin="-0.35s" repeatCount="indefinite" />
	</path>
<g class="ears">
...
<!-- 		<animate attributeName="d" values="M 155 242 Q 177 231 160 214 Z; M 155 242 Q 177 231 160 214 Z;  M 155 242 Q 171 222 148 215 Z; M 155 242 Q 171 222 148 215 Z;M 155 242 Q 177 231 160 214 Z; M 155 242 Q 177 231 160 214 Z" dur="2.8s" begin="-0.7s" repeatCount="indefinite" /> -->
	</path>

	<path class="horseEarL" d="M 147 245 Q 169 230 137 218 Z" fill="rgb(67,67,67)">
<!-- 		<animate attributeName="d" values="M 147 250 Q 172 239 150 220 Z;  M 147 250 Q 172 239 150 220 Z;M 147 245 Q 169 230 137 218 Z; M 147 245 Q 169 230 137 218 Z; M 147 250 Q 172 239 150 220 Z; M 147 250 Q 172 239 150 220 Z" dur="2.8s" begin="-0.6s" repeatCount="indefinite" /> -->
	</path>
	</g>
	<path class="horseTail" d="M 366 288 Q 390 306 388 337 Q 387 357 370 382 Q 375 371 373 343 Q 371 328 369 314" fill="rgb(67,67,67)">
		<animate attributeName="d" values="M 366 288 Q 390 306 388 337 Q 387 357 370 382 Q 375 371 373 343 Q 371 328 369 314; M 366 293 Q 395 310 391 336 Q 387 357 400 385 Q 375 371 376 330 Q 375 318 369 314; M 366 288 Q 390 306 388 337 Q 387 357 370 382 Q 375 371 373 343 Q 371 328 369 314" dur="1.4s" repeatCount="indefinite" />
	</path>

	<path class="ropeWagonHorse" d="M 477 364 Q 387 342 276 305" stroke="rgb(35,35,35)" stroke-width="3" fill="none">
		<animate attributeName="d" values="M 477 364 Q 387 342 276 305; M 477 364 Q 387 342 276 310; M 477 364 Q 387 342 276 305" dur="0.7s" begin="-0.35s" repeatCount="indefinite" />
	</path>

	<path class="ropeHorseFrontMid" d="M 277 304 L 190 301" stroke="rgb(35,35,35)" stroke-width="6" fill="none">
		<animate attributeName="d" values="M 277 304 L 190 301; M 277 308 L 189 309; M 277 304 L 190 301" dur="0.7s" begin="-0.35s" repeatCount="indefinite" />
	</path>

	<path class="ropeHorseMidBtm" d="M 275 302 L 277 346" stroke="rgb(35,35,35)" stroke-width="5" fill="none">
		<animate attributeName="d" values="M 275 300 L 275 344; M 275 304 L 275 348; M 275 300 L 275 344" dur="0.7s" repeatCount="indefinite" />
	</path>

	<path class="ropeHorseMidTop" d="M 275 302 L 277 346" stroke="rgb(35,35,35)" stroke-width="8" fill="none">
		<animate attributeName="d" values="M 275 301 L 277 264; M 275 305 L 277 266; M 275 301 L 277 264" dur="0.7s" begin="-0.35s" repeatCount="indefinite" />
	</path>

	<path class="ropeHorseNeckMidTop" d="M 255 302 L 257 346" stroke="rgb(35,35,35)" stroke-width="4" fill="none">
		<animate attributeName="d" values="M 220 306 L 224 254; M 220 305 L 224 253; M 220 306 L 224 254" dur="0.7s" begin="-0.05s" repeatCount="indefinite" />
	</path>

	<path class="ropeHorseNeckFrontTop" d="M 173 293 L 173 235" stroke="rgb(35,35,35)" stroke-width="4" fill="none">
		<animate attributeName="d" values="M 175 290 L 164 238; M 180 283 L 168 236; M 175 290 L 164 238" dur="0.7s" begin="0s" repeatCount="indefinite" />
	</path>

	<path class="ropeHorseFaceFrontTop" d="M 166 237 L 146 303" stroke="rgb(35,35,35)" stroke-width="4" fill="none">
		<animate attributeName="d" values="M 162 237 L 146 301; M 167 233 L 145 295; M 162 237 L 146 301" dur="0.7s" begin="0s" repeatCount="indefinite" />
	</path>

	<path class="ropeHorseFaceFrontTop2" d="M 168 237 L 150 303" stroke="rgb(35,35,35)" stroke-width="4" fill="none">
		<animate attributeName="d" values="M 163 237 L 150 301; M 168 233 L 150 295; M 163 237 L 150 301" dur="0.7s" begin="0s" repeatCount="indefinite" />
	</path>

	<path class="ropeHorseBlinder" d="M 140 266 L 157 272" stroke="rgb(35,35,35)" stroke-width="12" fill="none">
		<animate attributeName="d" values="M 139 267 L 157 272; M 141 263 L 158 269; M 139 267 L 157 272" dur="0.7s" begin="0s" repeatCount="indefinite" />
	</path>

	<path class="ropeHorseMouthTop" d="M 135 293 L 168 300" stroke="rgb(35,35,35)" stroke-width="4" fill="none">
		<animate attributeName="d" values="M 134 289 L 164 298; M 136 294 L 168 302; M 134 289 L 164 298" dur="0.7s" begin="-0.35s" repeatCount="indefinite" />
	</path>

	<path class="ropeHorseMouthBtm" d="M 135 293 L 168 300" stroke="rgb(35,35,35)" stroke-width="4" fill="none">
		<animate attributeName="d" values="M 133 291 L 163 300; M 135 296 L 166 304; M 133 291 L 163 300" dur="0.7s" begin="-0.35s" repeatCount="indefinite" />
	</path>

	<path class="ropeHandHorseBtm" d="M 452 268 Q 387 342 148 294" stroke="rgb(35,35,35)" stroke-width="3" fill="none">
		<animate attributeName="d" values="M 452 266 Q 270 305 148 295; M 452 266 Q 270 305 149 300; M 452 266 Q 270 305 148 295" dur="0.7s" begin="-0.35s" repeatCount="indefinite" />
	</path>

	<g>

		<path class="waistcoatUpper" d="M 567 282 V 260 Q 567 223 533 223 L 537 282 Z" fill="rgb(35,35,35)">
			<animate attributeName="d" values="M 567 282 V 260 Q 567 223 533 223 L 537 284 Z; M 567 282 V 260 Q 567 223 532 224 L 537 284 Z; M 567 282 V 260 Q 567 223 533 223 L 537 284 Z" dur=".4s" begin="0s" repeatCount="indefinite" />
		</path>
